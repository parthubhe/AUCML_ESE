"""
train_model.py - Robust training pipeline with safe SMOTE/SMOTENC handling and fallback.
...
# -------- CONFIG --------
USE_TOP_N = True
TOP_N = 25         # you set this to 50
USE_GROUPING = True
USE_SMOTE = True   # you turned this on
...
def train_and_save(X, y, encoders, le_target, df_encoded, metadata):
    ...
    # base classifier
    base_clf = RandomForestClassifier(n_estimators=250, random_state=RANDOM_STATE, n_jobs=-1, class_weight='balanced')
